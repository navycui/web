    ...
    Eclipse = (function(){
        ...
        function eclipse(element, settings){
            ...
            _.defaults = {
                ...
                startIndex: 0, // 슬라이더 시작 인덱스값 지정
                arrow: true, // 화살표 네이게이션 사용 여부
                pager: true, // 단추 네이게이션 사용 여부
                slidesToShow: 1, // 한번에 보여질 slide 갯수
                slidesToMove: 1, // 한번에 이동될 slides 갯수
                speed: 500, // 슬라이드 전환속도(단위:ms)
                margin: 0, // 슬라이드 간격(단위:px)
                friction: 200, // 마우스드래그 및 터치무브로 슬라이드 전환시 감도조절(단위:px)
                countIndex: 0, // 첫번째 활성 슬라이드의 인덱스값을 조절
                autoplay: false, // 자동 롤링 사용여부
                interval: 3000, // 자동 롤링 시간간격(단위:ms)
                autoControl: false, // 자동롤링 controler 사용 여부
                adaptiveHeight: false,//슬라이더 높이값 반응여부
                connected: null,
            ...
            _.initials = {
                ...
                thisLastIndex: 2, // active중 마지막 index
