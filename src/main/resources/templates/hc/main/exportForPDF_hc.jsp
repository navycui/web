...
if(null != report_key){
	...
	LocalDate  dtDate = new LocalDate();
    String yyyyMMdd= dtDate.now().DateTimeFormatter.ofPattern("yyyy/MM/dd/").toString();
    File MakeDirdd = new File(fileLoc + yyyyMMdd);
    MakeDirdd.mkdirs();
    File localFileSave = new File(fileLoc + yyyyMMdd + fileNm + ".pdf");
